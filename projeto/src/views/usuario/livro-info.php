                ...
                <div class="livroInfo">
                    ...
                    <div class="livroReservar">
                        ...
                        <button id="botaoReserva" 
                            ...
                            <?php 
                            if ($tem_reserva_ativa) echo 'Livro Reservado';
                            elseif ($livro_disponivel) echo 'Reservar';
                            else echo 'Sem Exemplares';
                            ?>
                        </button>
                    </div>
                    ...
                    <div class="info_2">
                        ...
                        <div class="publicacao">
                            ...
                            <p>
                                <?php 
                                $publicacao = [];
                                if (!empty($livro['editora_nome'])) $publicacao[] = htmlspecialchars($livro['editora_nome']);
                                if (!empty($livro['ano_publicacao'])) $publicacao[] = $livro['ano_publicacao'];
            ...
            <?php if ($usuario_logado): ?>
                <form id="commentForm">
                    <div class="inputRating">
                        <img class="estrela-input" src="<?php echo $URLBASE ?>/public/assets/icons/livro-info-estrela.png" data-value="1">
                        <img class="estrela-input" src="<?php echo $URLBASE ?>/public/assets/icons/livro-info-estrela.png" data-value="2">
                        <img class="estrela-input" src="<?php echo $URLBASE ?>/public/assets/icons/livro-info-estrela.png" data-value="3">
                        <img class="estrela-input" src="<?php echo $URLBASE ?>/public/assets/icons/livro-info-estrela.png" data-value="4">
                    </div>
                    <input type="text" id="comentario-input" placeholder="Escreva sua opinião..." maxlength="500">
