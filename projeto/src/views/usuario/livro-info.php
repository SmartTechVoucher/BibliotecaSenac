        ...
        <div class="containerInfo">
            ...
            <div class="info_1">
                <div class="livroInfo">
                    ...
                    <!-- Avaliações -->
                    <div class="review">
                        <img id="avaliacaoMediaImg" src="<?php echo $URLBASE ?>/public/assets/icons/estrelas0.png" alt="Avaliação média">
                        <p><span id="mediaEstrelas">0.0</span> (<span id="totalReviews">0</span> avaliações)</p>
                    </div>
