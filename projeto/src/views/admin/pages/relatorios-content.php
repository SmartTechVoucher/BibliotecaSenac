    <form id="cadastro-form" 
        action="<?php echo $URLBASE ?>/src/controller/admin/gerar-relatorio.php"
        method="post" enctype="multipart/form-data" 
        name="cadastrarRelatorios">

        <div class="form-row">

            <div class="form-grupo">
                <label for="genero">
                    <img src="<?php echo $URLBASE ?>/public/assets/icons/relatorio.png" alt="" class="icons">
                    Sobre:
                </label>
            ...
            <div class="form-grupo">
                <label for="formato">
                    <img src="<?php echo $URLBASE ?>/public/assets/icons/exportar.png" alt="" class="icons">
            ...
            <!-- <div class="form-grupo">
                <label for="unidade_senac">
                    <img src="<?php echo $URLBASE ?>/public/assets/icons/unidade.png" alt="" class="icons">
                    Unidade:
                </label>
            ...
            <div class="form-grupo">
                <label for="inicio">
                    <img src="<?php echo $URLBASE ?>/public/assets/icons/calendario-antes.png" alt="" class="icons">
                    Começando de:
                </label>
            ...
            <div class="form-grupo">
                <label for="fim">
                    <img src="<?php echo $URLBASE ?>/public/assets/icons/calendario-depois.png" alt="" class="icons">
                    Até:
                </label>
            ...
            <div class="form-grupo">
                <label for="ordenagem">
                    <img src="<?php echo $URLBASE ?>/public/assets/icons/ordenagem.png" alt="" class="icons">
                    Ordenagem:
                </label>
